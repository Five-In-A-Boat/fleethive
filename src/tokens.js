...
const tokens = {
  light: {
    ...
    cardBdr:     "#DDD8D0",
    checkDim:    "#8A8480",
    ghostBdr:    "rgba(0,0,0,0.12)",
    dividerLine: "rgba(0,0,0,0.06)",
    infoBg:      "rgba(47,111,237,0.05)",
    infoBdr:     "rgba(47,111,237,0.12)",
    infoText:    "#2F6FED",
    footerText:  "#8A8480",
  },
  dark: {
    ...
    cardBdr:     "#1C2030",
    checkDim:    "#706A64",
    ghostBdr:    "rgba(255,255,255,0.10)",
    dividerLine: "rgba(255,255,255,0.06)",
    infoBg:      "rgba(125,166,255,0.08)",
    infoBdr:     "rgba(125,166,255,0.15)",
    infoText:    "#7DA6FF",
    footerText:  "#5A5550",
  },
  // Brand accent colors
